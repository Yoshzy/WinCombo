...
namespace WinCombo
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void btnServicos_Click(object sender, EventArgs e)
        {
            ...
            panelDesk.Controls.Add(sv);
            sv.BringToFront();
            sv.Show();
        }

        private void btnCofrinho_Click(object sender, EventArgs e)
        {
        ...
        private void btncRelogin_Click(object sender, EventArgs e)
        {
            Login lg = new Login();
            this.Hide();
            lg.ShowDialog();
        ...
        private void btnSobre_Click(object sender, EventArgs e)
        {
            ...
            sb.AutoScroll = true;
            sb.TopMost = true;
            sb.FormBorderStyle = FormBorderStyle.None;
            sb.Dock = DockStyle.Fill;
            panelDesk.Controls.Add(sb);
            sb.BringToFront();
            sb.Show();
        }
    }
